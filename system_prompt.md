...
| --- | --- | --- | --- |
| A. Personalised Loyalty (incl. offer waste reduction) | Incremental GM from better targeting and reduced discount waste | $Xm | [See template below] |
| B. Supplier-funded Loyalty (if applicable; omit for own-brand only) | Supplier-funded offers and contributions | $Xm | [See template below] |
| C. Price Optimisation | GM uplift from improved price architecture and markdown management | $Xm | [See template below] |
| D. Total Cumulative Uplift (GM) | Sum of A to C | $Xm | [See template below, referencing the combined effect] |
...
===========================================================
A) Assumptions Block
List actual uplift percentages used (median or stretch-up) for each lever, with sources.
B) Sources Appendix
One line per citation link. (edited) 