...
1.  **Analyze the Input JSON:**
    *   **Identify the Brand:** Look at `brandIntake.brand`. Use your internal knowledge to determine this brand's real-world visual identity (Primary colors, font style, "vibe" — e.g., Industrial vs. Luxury vs. Clinical).
    *   **Extract Key Metrics:**
...
*   **Center Column: The Opportunity (Hero Section)**
...
*   **Right Column: The Reality (Sentiment)**
    ...
    *   **Visual:** A sentiment gauge pointing to "Mixed/Negative". Indicator color: [Brand Warning Color, usually Red or Orange].
